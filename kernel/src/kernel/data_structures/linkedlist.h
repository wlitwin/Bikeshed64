#ifndef __DATA_STRUCTURES_LINKED_LIST_H__
#define __DATA_STRUCTURES_LINKED_LIST_H__
 ...
 * Returns: Nothing
 */
void list_init(linked_list_t* list, void* (*ram_alloc)(uint64_t), void (*destroy)(void *data));
